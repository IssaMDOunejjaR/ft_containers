...
/*   Updated: 2021/09/21 17:41:41 by iounejja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
	...
	class Tree {
		...
		// Node*	secondMiniKey(Node * node, Key & key) {
		// 	Node*	tmp;
		...
		// 	tmp = node;
		// 	return secondMiniKey(node->left, key);
		// }
		...
		public:
			...
			// Node*	secondMinElement(Key & val) {
			// 	return secondMiniKey(root, val);
			// }
